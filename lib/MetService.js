...
module.exports.getAlerts = function getAlerts() {
    return __awaiter(this, void 0, void 0, function* () {
        const feed = yield parser.parseURL("https://alerts.metservice.com/cap/rss");
        const alerts = [];
        feed.items.forEach((item) => __awaiter(this, void 0, void 0, function* () {
            ...
            request(item.link, function (error, response, body) {
                ...
                var infoObj = info.map(({ name, elements }) => ({ name, elements })).reduce((acc, { name, elements }) => (Object.assign(Object.assign({}, acc), { [name]: elements[0].text })), {}); // I'm gonna be honest, I have no idea how the fuck copilot did this, but it works. Thanks copilot <3
